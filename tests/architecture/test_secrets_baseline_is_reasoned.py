...
def test_the_suppression_count_only_shrinks() -> None:
    ...
    threshold, adding one reviewed public immutable-release fingerprint. The
    dependency-bundle policy adds one public immutable Git commit ID, so the
    reviewed suppression total is 29.
