...
REASONS = {
    ...
    "docs/kernel-runtime-composition.json": (
        ...
        "universe/manifest reading, and "
        "tests/architecture/test_kernel_runtime_composition.py's own "
        "test_envelope_product_and_revision_match_the_expected_values), "
        "which is exactly why the entropy heuristic fires. It "
