...
class TestAssetDisposalService:
    ...
    def test_create_disposal_success(self, mock_db, org_id, mock_asset, user_id):
        ...
        from app.services.ifrs.fa.disposal import AssetDisposalService, DisposalInput
        from app.models.ifrs.fa.asset_disposal import DisposalType
        ...
        result = AssetDisposalService.create_disposal(mock_db, org_id, input_data, user_id)
    ...
    def test_approve_disposal_success(self, mock_db, org_id, mock_asset, user_id):
        ...
        from app.services.ifrs.fa.disposal import AssetDisposalService
    ...
    def test_approve_disposal_not_found(self, mock_db, org_id, user_id):
        ...
        with pytest.raises(HTTPException) as exc_info:
            AssetDisposalService.approve_disposal(mock_db, org_id, uuid.uuid4(), user_id)
    ...
    def test_approve_disposal_already_approved(self, mock_db, org_id, mock_asset, user_id):
        ...
        with pytest.raises(HTTPException) as exc_info:
            AssetDisposalService.approve_disposal(mock_db, org_id, disposal.disposal_id, user_id)
