...
class TestPostReceipt:
    ...
    @patch("app.services.ifrs.inv.inv_posting_adapter.LedgerPostingService")
    @patch("app.services.ifrs.inv.inv_posting_adapter.JournalService")
    def test_post_receipt_success(self, mock_journal_service, mock_ledger_posting):
        ...
        mock_ledger_posting.post_journal_entry.return_value = MockPostingResult(success=True)
...
class TestPostTransaction:
    ...
    @patch.object(INVPostingAdapter, "post_receipt")
    ...
    @patch.object(INVPostingAdapter, "post_issue")
    ...
    @patch.object(INVPostingAdapter, "post_adjustment")
