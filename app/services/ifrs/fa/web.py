...
from app.services.ifrs.fa.asset import asset_service, asset_category_service, AssetInput, AssetCategoryInput
...
class FixedAssetWebService:
    ...
    def asset_new_form_response(
        ...
        return templates.TemplateResponse(request, "ifrs/fa/asset_form.html", context)
    ...
    def create_asset_response(
        ...
        try:
            ...
            return RedirectResponse(url="/fa/assets", status_code=303)
    ...
    def list_categories_response(
        ...
        return templates.TemplateResponse(request, "ifrs/fa/categories.html", context)
    ...
    def new_category_form_response(
        ...
        context["error"] = error
        return templates.TemplateResponse(request, "ifrs/fa/category_form.html", context)
    ...
    async def create_category_response(
        ...
        try:
            ...
            return RedirectResponse(url="/fa/categories", status_code=303)
        except Exception as e:
    ...
    def edit_category_form_response(
        ...
        if not category or category.organization_id != auth.organization_id:
            return RedirectResponse(url="/fa/categories", status_code=302)
