...
class TaxReportService:
    ...
    def get_vat_return_data(
        ...
        results = (
            ...
            .group_by(TaxCode.rate, TaxTransaction.transaction_type)
            .all()
        )
    ...
    def get_wht_report(
        ...
        for tax_code, tax_name, rate, source_module, total_base, total_tax, count in results:
            ...
            by_rate.append({
                ...
                "base_amount": float(total_base or 0),
