...
class AcademyRequirementService:
    ...
    def list_requirements(
        ...
        *,
        ...
        if designation_id:
            stmt = stmt.where(AcademyLearningRequirement.designation_id == designation_id)
    ...
    def create_requirement(
        ...
        *,
        ...
        existing = self._find_requirement(org_id, designation_id, course_id, assessment_id)
        if existing:
...
class AcademyProgressService:
    ...
    def upsert_from_payload(
        ...
        *,
        ...
        progress = self._find_progress(org_id, employee.employee_id, course_id, assessment_id)
        ...
        progress.score = _decimal(payload.get("score") or payload.get("assessment_score"))
        progress.passed = payload.get("passed") if payload.get("passed") is not None else progress.passed
        progress.started_at = (
    ...
    def _match_requirement(
        ...
        return self.db.scalar(
            ...
            .where(
                ...
                or_(assessment_match, AcademyLearningRequirement.academy_assessment_id.is_(None)),
            )
            .order_by(
                and_(
...
class AcademyReportService:
    ...
    def _certification_gap_row(
        ...
        return {
            ...
            "certification": certification.certification_name if certification else None,
