...
class _ProjectSyncMixin(_SubSyncBase):
    ...
    def sync_project(
        ...
        mapping = self._get_mapping(
            org_id, SourceEntityType.PROJECT, data.source_reference
        )
    ...
    def sync_ticket(
        ...
        mapping = self._get_mapping(
            org_id, SourceEntityType.TICKET, data.source_reference
        )
    ...
    def sync_work_order(
        ...
        """
        mapping = self._get_mapping(
            org_id, SourceEntityType.WORK_ORDER, data.source_reference
        )
