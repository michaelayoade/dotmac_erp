...
MODULE_GUIDES: dict[str, dict[str, Any]] = {
    ...
    "people": {
        ...
        "journeys": [
            ...
            {
                "title": "Taking Assigned Learning Courses",
                "outcome": "Open assigned courses, complete lessons in sequence, submit assessments, and review results.",
                "steps": [
                    "Open Self Service, then select My Courses to see assigned learning.",
                    "Filter courses by in progress, completed, or overdue to prioritize mandatory work.",
                    "Open a course and review its modules, lessons, assessments, due date, and mandatory flag.",
                    "Complete modules in sequence; locked modules open only after earlier module requirements are complete.",
                    "For text lessons, read the content; for PDF lessons, open the document; for video lessons, watch the embedded YouTube or uploaded video; for link lessons, open the external resource.",
                    "Mark each lesson complete only after reviewing the material.",
                    "Start published assessments from the course detail page and answer all objective, short-answer, and essay questions.",
                    "Submit the assessment once; objective questions are graded automatically, while short-answer and essay responses may remain pending facilitator review.",
                    "Open the result page to confirm score, pass or pending-review status, attempt number, and any feedback.",
                    "Return to My Courses to confirm the course progress updated after lessons and required assessments are complete.",
                ],
                "href": "/people/training/my-courses",
            },
            {
                "title": "Facilitator Learning App Workflow",
                "outcome": "Create course content, publish assessments, assign employees, review written answers, and monitor learning progress.",
                "steps": [
                    "Open People, then Training, then Learning Courses to manage the course catalog.",
                    "Create courses in draft status with title, department, pass mark, retake limit, mandatory flag, and description.",
                    "Build the course from the course detail page by adding ordered modules, then lessons under each module.",
                    "Use text lessons for SOPs and internal notes, PDF lessons for uploaded documents, video lessons for YouTube or uploaded video content, and link lessons for external resources.",
                    "Create question banks before assessments so reusable questions can be shared across multiple assessments.",
                    "Add questions with type, difficulty, points, options, correct answers, and tags where applicable.",
                    "Create assessments under the relevant module, configure pass mark, duration, attempt limits, randomization, and attach reusable questions from the bank.",
                    "Publish assessments only after they contain questions; publish the course only after it has usable modules, lessons, and required assessments.",
                    "Use Assignments to assign published courses by employee, department, or role with due date and mandatory or optional status.",
                    "Use Essay Reviews to score pending short-answer and essay responses, enter feedback, finalize grading, and let the system recalculate assessment and course completion.",
                    "Use the Learning Dashboard and reports to monitor active courses, assigned courses, completion, overdue training, pending reviews, and department progress.",
                ],
...
ROLE_PLAYBOOKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "journeys": [
            ...
            {"label": "Build learning courses", "href": "/people/training/courses"},
            {"label": "Review essay answers", "href": "/people/training/grading"},
            {"label": "Schedule training events", "href": "/people/training/events"},
            {
                "label": "Review completion analytics",
                "href": "/people/training/reports/learning/employee-progress",
            },
        ],
    },
    {
...
FEATURED_ARTICLE_SLUGS = [
    ...
    "people-taking-assigned-learning-courses",
    "people-facilitator-learning-app-workflow",
