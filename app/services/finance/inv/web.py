...
class InventoryWebService:
    ...
    def list_items_response(
        ...
        return templates.TemplateResponse(request, "operations/inv/items.html", context)
    ...
    def item_new_form_response(
        ...
        return templates.TemplateResponse(request, "operations/inv/item_form.html", context)
    ...
    def item_detail_response(
        ...
        return templates.TemplateResponse(request, "operations/inv/item_detail.html", context)
    ...
    def list_transactions_response(
        ...
        return templates.TemplateResponse(request, "operations/inv/transactions.html", context)
    ...
    def list_categories_response(
        ...
        return templates.TemplateResponse(request, "operations/inv/categories.html", context)
    ...
    def category_form_response(
        ...
        return templates.TemplateResponse(request, "operations/inv/category_form.html", context)
    ...
    def list_warehouses_response(
        ...
        return templates.TemplateResponse(request, "operations/inv/warehouses.html", context)
    ...
    def warehouse_form_response(
        ...
        return templates.TemplateResponse(request, "operations/inv/warehouse_form.html", context)
    ...
    def warehouse_detail_response(
        ...
        if not context.get("warehouse"):
            return RedirectResponse(url="/operations/inv/warehouses", status_code=303)
        return templates.TemplateResponse(request, "operations/inv/warehouse_detail.html", context)
...
class InventoryTransactionWebService:
    ...
    def transaction_form_response(
        ...
        template_map = {
            "RECEIPT": "operations/inv/receipt_form.html",
            "ISSUE": "operations/inv/issue_form.html",
            "TRANSFER": "operations/inv/transfer_form.html",
            "ADJUSTMENT": "operations/inv/adjustment_form.html",
        }
        template = template_map.get(transaction_type, "operations/inv/receipt_form.html")
