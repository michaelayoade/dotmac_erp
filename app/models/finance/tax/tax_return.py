...
class TaxReturn(Base):
    ...
    # Amounts
    total_output_tax: Mapped[Decimal] = mapped_column(Numeric(20, 6), nullable=False, default=0)
    total_input_tax: Mapped[Decimal] = mapped_column(Numeric(20, 6), nullable=False, default=0)
    net_tax_payable: Mapped[Decimal] = mapped_column(Numeric(20, 6), nullable=False, default=0)
    adjustments: Mapped[Decimal] = mapped_column(Numeric(20, 6), nullable=False, default=0)
    final_amount: Mapped[Decimal] = mapped_column(Numeric(20, 6), nullable=False, default=0)
    ...
    filed_by_user_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), nullable=True)
    ...
    # Review
    prepared_by_user_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), nullable=True)
