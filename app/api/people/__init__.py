...
def include_people_routes(target_router: APIRouter) -> APIRouter:
    ...
    target_router.include_router(hr_router)
    target_router.include_router(import_router)
    target_router.include_router(payroll_router)
    target_router.include_router(leave_router)
    target_router.include_router(attendance_router)
    target_router.include_router(scheduling_router)
    target_router.include_router(recruit_router)
    target_router.include_router(training_router)
    target_router.include_router(perf_router)
    target_router.include_router(expense_router)
