...
from app.services.finance.fin_inst.web import fin_inst_web_service
...
def list_instruments(
    ...
    return templates.TemplateResponse(request, "finance/fin_inst/instruments.html", context)
...
def list_hedges(
    ...
    return templates.TemplateResponse(request, "finance/fin_inst/hedges.html", context)
