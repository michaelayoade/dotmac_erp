...
def list_suppliers(
    ...
    """Suppliers list page."""
    return ap_web_service.list_suppliers_response(request, auth, search, status, page, limit, db)
...
async def bulk_delete_suppliers(
    ...
    from app.services.ifrs.ap.bulk import get_supplier_bulk_service
...
async def bulk_delete_invoices(
    ...
    from app.schemas.bulk_actions import BulkActionRequest
    from app.services.ifrs.ap.invoice_bulk import get_ap_invoice_bulk_service
...
async def bulk_delete_payments(
    ...
    from app.schemas.bulk_actions import BulkActionRequest
    from app.services.ifrs.ap.payment_bulk import get_ap_payment_bulk_service
