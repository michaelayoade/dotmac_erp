...
def downgrade() -> None:
    op.drop_index("idx_attendance_request_dates", table_name="attendance_request", schema="attendance")
    op.drop_index("idx_attendance_request_status", table_name="attendance_request", schema="attendance")
    op.drop_index("idx_attendance_request_employee", table_name="attendance_request", schema="attendance")
    op.drop_index("idx_attendance_request_org", table_name="attendance_request", schema="attendance")
    op.drop_table("attendance_request", schema="attendance")

    op.drop_index("idx_shift_assignment_shift_type", table_name="shift_assignment", schema="attendance")
    op.drop_index("idx_shift_assignment_employee", table_name="shift_assignment", schema="attendance")
    op.drop_index("idx_shift_assignment_org", table_name="shift_assignment", schema="attendance")
