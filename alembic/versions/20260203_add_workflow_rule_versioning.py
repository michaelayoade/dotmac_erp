...
def upgrade() -> None:
    ...
    # Extend enums for new workflow entity types
    ...
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'ASSET_DISPOSAL'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'EMPLOYEE'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'LEAVE_REQUEST'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'DISCIPLINARY_CASE'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'PERFORMANCE_APPRAISAL'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'PAYROLL_RUN'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'PAYROLL_ENTRY'")
    ...
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'FLEET_VEHICLE'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'FLEET_RESERVATION'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'FLEET_MAINTENANCE'")
    op.execute("ALTER TYPE workflow_entity_type ADD VALUE IF NOT EXISTS 'FLEET_INCIDENT'")

    # Extend enums for trigger event and action type
    op.execute("ALTER TYPE workflow_trigger_event ADD VALUE IF NOT EXISTS 'ON_SCHEDULE'")
