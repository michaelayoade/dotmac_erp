...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "requires_receipt", sa.Boolean(), nullable=False, server_default="true"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "amount_settled", sa.Numeric(12, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "amount_refunded", sa.Numeric(12, 2), nullable=False, server_default="0.00"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["cost_center_id"], ["core_org.cost_center.cost_center_id"]
        ),
        sa.ForeignKeyConstraint(["advance_account_id"], ["gl.account.account_id"]),
        sa.ForeignKeyConstraint(
            ["journal_entry_id"], ["gl.journal_entry.journal_entry_id"]
        ),
    ...
    op.create_index(
        "idx_cash_advance_org", "cash_advance", ["organization_id"], schema="expense"
    )
    op.create_index(
        "idx_cash_advance_employee", "cash_advance", ["employee_id"], schema="expense"
    )
    op.create_index(
        "idx_cash_advance_status",
        "cash_advance",
        ["organization_id", "status"],
        schema="expense",
    )
    op.create_index(
        "idx_cash_advance_erpnext", "cash_advance", ["erpnext_id"], schema="expense"
    )
    ...
    op.create_table(
        ...
        sa.Column("currency_code", sa.String(3), nullable=False, server_default="NGN"),
        sa.Column(
            "advance_adjusted", sa.Numeric(12, 2), nullable=False, server_default="0.00"
        ),
        ...
        sa.ForeignKeyConstraint(["approver_id"], ["hr.employee.employee_id"]),
        sa.ForeignKeyConstraint(
            ["cash_advance_id"], ["expense.cash_advance.advance_id"]
        ),
        sa.ForeignKeyConstraint(
            ["cost_center_id"], ["core_org.cost_center.cost_center_id"]
        ),
        sa.ForeignKeyConstraint(
            ["supplier_invoice_id"], ["ap.supplier_invoice.invoice_id"]
        ),
        sa.ForeignKeyConstraint(["status_changed_by_id"], ["people.id"]),
        sa.ForeignKeyConstraint(["created_by_id"], ["people.id"]),
        sa.ForeignKeyConstraint(["updated_by_id"], ["people.id"]),
    ...
    op.create_index(
        "idx_expense_claim_org", "expense_claim", ["organization_id"], schema="expense"
    )
    op.create_index(
        "idx_expense_claim_employee", "expense_claim", ["employee_id"], schema="expense"
    )
    op.create_index(
    ...
    op.create_index(
        "idx_expense_claim_date",
        "expense_claim",
        ["organization_id", "claim_date"],
        schema="expense",
    )
    op.create_index(
        "idx_expense_claim_erpnext", "expense_claim", ["erpnext_id"], schema="expense"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "is_travel_expense", sa.Boolean(), nullable=False, server_default="false"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["expense.expense_category.category_id"]
        ),
        sa.ForeignKeyConstraint(["expense_account_id"], ["gl.account.account_id"]),
        sa.ForeignKeyConstraint(
            ["cost_center_id"], ["core_org.cost_center.cost_center_id"]
    ...
    op.create_index(
        "idx_expense_claim_item_org",
        "expense_claim_item",
        ["organization_id"],
        schema="expense",
    )
    op.create_index(
        "idx_expense_claim_item_claim",
        "expense_claim_item",
        ["claim_id"],
        schema="expense",
    )
    op.create_index(
        "idx_expense_claim_item_category",
        "expense_claim_item",
        ["category_id"],
        schema="expense",
    )
    ...
    op.create_index(
        "idx_corporate_card_org",
        "corporate_card",
        ["organization_id"],
        schema="expense",
    )
    op.create_index(
        "idx_corporate_card_employee",
        "corporate_card",
        ["employee_id"],
        schema="expense",
    )
    op.create_index(
        "idx_corporate_card_erpnext", "corporate_card", ["erpnext_id"], schema="expense"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "is_personal_expense", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "personal_deduction_from_salary",
            sa.Boolean(),
            nullable=False,
        ...
        sa.ForeignKeyConstraint(
            ["expense_claim_id"], ["expense.expense_claim.claim_id"]
        ),
        sa.ForeignKeyConstraint(["created_by_id"], ["people.id"]),
        sa.ForeignKeyConstraint(["updated_by_id"], ["people.id"]),
        schema="expense",
    ...
    op.create_index(
        "idx_card_transaction_org",
        "card_transaction",
        ["organization_id"],
        schema="expense",
    )
    op.create_index(
        "idx_card_transaction_card", "card_transaction", ["card_id"], schema="expense"
    )
    op.create_index(
        "idx_card_transaction_date",
        "card_transaction",
        ["organization_id", "transaction_date"],
        schema="expense",
    )
    op.create_index(
        "idx_card_transaction_status",
        "card_transaction",
        ["organization_id", "status"],
        schema="expense",
    )
