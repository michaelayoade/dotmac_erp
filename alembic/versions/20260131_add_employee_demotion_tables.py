...
def upgrade() -> None:
    ...
    demotion_reason.create(bind, checkfirst=True)
    ...
    demotion_status.create(bind, checkfirst=True)

    # Create employee_demotion table
    if not inspector.has_table("employee_demotion", schema="hr"):
        op.create_table(
            "employee_demotion",
            sa.Column(
                "demotion_id",
    ...
    # Create indexes for employee_demotion
    if inspector.has_table("employee_demotion", schema="hr"):
        indexes = {
            idx["name"]
            for idx in inspector.get_indexes("employee_demotion", schema="hr")
            if idx.get("name")
        }
        if "idx_demotion_employee" not in indexes:
            op.create_index(
        ...
        if "idx_demotion_status" not in indexes:
            op.create_index(
                "idx_demotion_status",
                "employee_demotion",
        ...
        if "idx_demotion_discipline_case" not in indexes:
            op.create_index(
    ...
    if not inspector.has_table("employee_demotion_detail", schema="hr"):
        op.create_table(
    ...
    if inspector.has_table("employee_demotion_detail", schema="hr"):
        indexes = {
            idx["name"]
            for idx in inspector.get_indexes("employee_demotion_detail", schema="hr")
            if idx.get("name")
        }
        if "idx_demotion_detail_demotion" not in indexes:
            op.create_index(
...
def downgrade() -> None:
    ...
    if inspector.has_table("employee_demotion_detail", schema="hr"):
        ...
        if "idx_demotion_detail_demotion" in indexes:
            op.drop_index(
                "idx_demotion_detail_demotion",
    ...
    if inspector.has_table("employee_demotion", schema="hr"):
        ...
        if "idx_demotion_discipline_case" in indexes:
            op.drop_index(
                "idx_demotion_discipline_case",
                table_name="employee_demotion",
                schema="hr",
            )
        if "idx_demotion_status" in indexes:
            op.drop_index(
                "idx_demotion_status",
                table_name="employee_demotion",
                schema="hr",
            )
        if "idx_demotion_employee" in indexes:
            op.drop_index(
                "idx_demotion_employee",
                table_name="employee_demotion",
                schema="hr",
