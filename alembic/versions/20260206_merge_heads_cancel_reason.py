...
Revises: 20260206_add_inv_count_indexes, 20260206_add_item_category_reorder_levels, 20260206_add_material_request_cancel_reason, 2c732d9afaa6
...
down_revision = (
    ...
    "20260206_add_item_category_reorder_levels",
