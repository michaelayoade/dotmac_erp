...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "component_type",
            sa.Enum("EARNING", "DEDUCTION", name="salary_component_type"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_salary_component_org",
        "salary_component",
        ["organization_id"],
        schema="payroll",
    )
    op.create_index(
        "idx_salary_component_type",
        "salary_component",
        ["organization_id", "component_type"],
        schema="payroll",
    )
    op.create_index(
        "idx_salary_component_erpnext",
        "salary_component",
        ["erpnext_id"],
        schema="payroll",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "payroll_frequency",
            sa.Enum(
                "WEEKLY", "BIWEEKLY", "SEMIMONTHLY", "MONTHLY", name="payroll_frequency"
            ),
            default="MONTHLY",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["structure_id"],
            ["payroll.salary_structure.structure_id"],
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["component_id"], ["payroll.salary_component.component_id"]
        ),
        schema="payroll",
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["structure_id"], ["payroll.salary_structure.structure_id"]
        ),
        sa.ForeignKeyConstraint(["created_by_id"], ["people.id"]),
        sa.ForeignKeyConstraint(["updated_by_id"], ["people.id"]),
        schema="payroll",
    ...
    op.create_index(
        "idx_payroll_entry_org", "payroll_entry", ["organization_id"], schema="payroll"
    )
    op.create_index(
        "idx_payroll_entry_period",
        "payroll_entry",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["payroll_entry_id"], ["payroll.payroll_entry.entry_id"]
        ),
        sa.ForeignKeyConstraint(["created_by_id"], ["people.id"]),
        sa.ForeignKeyConstraint(["updated_by_id"], ["people.id"]),
    ...
    op.create_index(
        "idx_salary_slip_org", "salary_slip", ["organization_id"], schema="payroll"
    )
    op.create_index(
        "idx_salary_slip_emp", "salary_slip", ["employee_id"], schema="payroll"
    )
    op.create_index(
        "idx_salary_slip_period",
        "salary_slip",
        ["organization_id", "start_date", "end_date"],
        schema="payroll",
    )
    op.create_index(
        "idx_salary_slip_status",
        "salary_slip",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["slip_id"], ["payroll.salary_slip.slip_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["component_id"], ["payroll.salary_component.component_id"]
        ),
    ...
    op.create_index(
        "idx_slip_earning_slip", "salary_slip_earning", ["slip_id"], schema="payroll"
    )
