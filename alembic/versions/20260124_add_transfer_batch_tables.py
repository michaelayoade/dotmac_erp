...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("organization_id", "batch_number", name="uq_transfer_batch"),
        schema="payments",
    )

    op.create_index("idx_transfer_batch_org", "transfer_batch", ["organization_id"], schema="payments")
    op.create_index("idx_transfer_batch_status", "transfer_batch", ["organization_id", "status"], schema="payments")
    ...
    op.create_index("idx_transfer_batch_item_batch", "transfer_batch_item", ["batch_id"], schema="payments")
    op.create_index("idx_transfer_batch_item_claim", "transfer_batch_item", ["expense_claim_id"], schema="payments")
    op.create_index("idx_transfer_batch_item_intent", "transfer_batch_item", ["payment_intent_id"], schema="payments")
