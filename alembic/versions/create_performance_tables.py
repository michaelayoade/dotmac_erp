...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "include_probation_employees",
            sa.Boolean(),
            nullable=False,
            server_default="false",
        ),
        sa.Column(
            "min_tenure_months", sa.Integer(), nullable=False, server_default="3"
        ),
    ...
    op.create_index(
        "idx_appraisal_cycle_org", "appraisal_cycle", ["organization_id"], schema="perf"
    )
    op.create_index(
        "idx_appraisal_cycle_status",
        "appraisal_cycle",
        ["organization_id", "status"],
        schema="perf",
    )
    op.create_index(
        "idx_appraisal_cycle_dates",
        "appraisal_cycle",
        ["organization_id", "start_date", "end_date"],
        schema="perf",
    )
    op.create_index(
        "idx_appraisal_cycle_erpnext", "appraisal_cycle", ["erpnext_id"], schema="perf"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "default_weightage", sa.Numeric(5, 2), nullable=False, server_default="0.00"
        ),
    ...
    op.create_index(
        "idx_kra_dept", "kra", ["organization_id", "department_id"], schema="perf"
    )
    op.create_index(
        "idx_kra_desig", "kra", ["organization_id", "designation_id"], schema="perf"
    )
    ...
    op.create_index(
        "idx_appraisal_template_org",
        "appraisal_template",
        ["organization_id"],
        schema="perf",
    )
    op.create_index(
        "idx_appraisal_template_dept",
        "appraisal_template",
        ["organization_id", "department_id"],
        schema="perf",
    )
    op.create_index(
        "idx_appraisal_template_desig",
        "appraisal_template",
        ["organization_id", "designation_id"],
        schema="perf",
    )
    op.create_index(
        "idx_appraisal_template_erpnext",
        "appraisal_template",
        ["erpnext_id"],
        schema="perf",
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["template_id"], ["perf.appraisal_template.template_id"]
        ),
        sa.ForeignKeyConstraint(["kra_id"], ["perf.kra.kra_id"]),
        schema="perf",
    )
    op.create_index(
        "idx_template_kra_org",
        "appraisal_template_kra",
        ["organization_id"],
        schema="perf",
    )
    op.create_index(
        "idx_template_kra_template",
        "appraisal_template_kra",
        ["template_id"],
        schema="perf",
    )
    op.create_index(
        "idx_template_kra_kra", "appraisal_template_kra", ["kra_id"], schema="perf"
    )
    ...
    op.create_index(
        "idx_kpi_status", "kpi", ["organization_id", "status"], schema="perf"
    )
    op.create_index(
        "idx_kpi_period",
        "kpi",
    ...
    op.create_index(
        "idx_appraisal_org", "appraisal", ["organization_id"], schema="perf"
    )
    op.create_index(
        "idx_appraisal_employee", "appraisal", ["employee_id"], schema="perf"
    )
    ...
    op.create_index(
        "idx_kra_score_org", "appraisal_kra_score", ["organization_id"], schema="perf"
    )
    op.create_index(
        "idx_kra_score_appraisal",
        "appraisal_kra_score",
        ["appraisal_id"],
        schema="perf",
    )
    op.create_index(
        "idx_kra_score_kra", "appraisal_kra_score", ["kra_id"], schema="perf"
    )
    ...
    op.create_index(
        "idx_feedback_org", "appraisal_feedback", ["organization_id"], schema="perf"
    )
    op.create_index(
        "idx_feedback_appraisal", "appraisal_feedback", ["appraisal_id"], schema="perf"
    )
    op.create_index(
        "idx_feedback_from", "appraisal_feedback", ["feedback_from_id"], schema="perf"
    )
    ...
    op.create_index(
        "idx_scorecard_org", "scorecard", ["organization_id"], schema="perf"
    )
    op.create_index(
        "idx_scorecard_employee", "scorecard", ["employee_id"], schema="perf"
    )
    op.create_index(
        "idx_scorecard_period",
        "scorecard",
        ["organization_id", "period_start", "period_end"],
        schema="perf",
    )
    ...
    op.create_index(
        "idx_scorecard_item_org", "scorecard_item", ["organization_id"], schema="perf"
    )
    op.create_index(
        "idx_scorecard_item_scorecard",
        "scorecard_item",
        ["scorecard_id"],
        schema="perf",
    )
