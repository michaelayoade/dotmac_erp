...
AUDITED_2022_BALANCES = {
    ...
    "Property, Plant & Equipment": {
        "audited": Decimal("78201206"),
        "opening": Decimal("91855808"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "1",
    },
    "Inventories": {
        "audited": Decimal("28411728"),
        "opening": Decimal("42672377"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "2",
    },
    "Trade Receivables": {
        "audited": Decimal("58291409"),
        "opening": Decimal("45113657"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "3",
    },
    "Staff Loan": {
        "audited": Decimal("0"),
        "opening": Decimal("620000"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "3",
    },
    "WHT Receivable": {
        "audited": Decimal("65599797"),
        "opening": Decimal("37825259"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "3",
    },
    "Zenith Bank": {
        "audited": Decimal("105724794"),
        "opening": Decimal("9703896"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "4",
    },
    "Heritage Bank": {
        "audited": Decimal("100000"),
    ...
    "Cash at Hand": {
        "audited": Decimal("1460"),
        "opening": Decimal("80616"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "4",
    },
    "Paystack": {
        "audited": Decimal("416000"),
        "opening": Decimal("0"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "4",
    ...
    "Paystack OPEX": {
        "audited": Decimal("33772"),
        "opening": Decimal("131597"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "4",
    },
    "Flutterwave": {
        "audited": Decimal("1394008"),
        "opening": Decimal("0"),
        "type": "ASSETS",
        "normal": "DEBIT",
        "note": "4",
    ...
    "Share Capital": {
        "audited": Decimal("14650000"),
        "opening": Decimal("14650000"),
        "type": "EQUITY",
        "normal": "CREDIT",
        "note": "5",
    },
    "Retained Earnings": {
        "audited": Decimal("98986276"),
        "opening": Decimal("75686098"),
        "type": "EQUITY",
        "normal": "CREDIT",
        "note": "6",
    },
    ...
    "Long Term Borrowings": {
        "audited": Decimal("94554299"),
        "opening": Decimal("82203961"),
        "type": "LIABILITIES",
        "normal": "CREDIT",
        "note": "7",
    },
    "Trade Payables": {
        "audited": Decimal("107613478"),
        "opening": Decimal("14367458"),
        "type": "LIABILITIES",
        "normal": "CREDIT",
        "note": "8",
    },
    "WHT Payable": {
        "audited": Decimal("2211412"),
        "opening": Decimal("0"),
        "type": "LIABILITIES",
        "normal": "CREDIT",
        "note": "8",
    ...
    "Accrued Expenses": {
        "audited": Decimal("1656670"),
        "opening": Decimal("7705496"),
        "type": "LIABILITIES",
        "normal": "CREDIT",
        "note": "8",
    },
    "Income Tax Payable": {
        "audited": Decimal("17800988"),
        "opening": Decimal("29798003"),
        "type": "LIABILITIES",
        "normal": "CREDIT",
        "note": "9",
    },
    "Education Tax Payable": {
        "audited": Decimal("1483416"),
        "opening": Decimal("2719112"),
        "type": "LIABILITIES",
        "normal": "CREDIT",
        "note": "9",
    },
    "IT Levy Payable": {
        "audited": Decimal("593366"),
        "opening": Decimal("928562"),
        "type": "LIABILITIES",
        "normal": "CREDIT",
        "note": "9",
    },
...
AUDITED_2022_PL = {
    # REVENUE
    "Internet Revenue": {
        "audited": Decimal("513205564"),
        "type": "REVENUE",
        "normal": "CREDIT",
        "note": "10",
    },
    "Other Business Revenue": {
        "audited": Decimal("1051801233"),
        "type": "REVENUE",
        "normal": "CREDIT",
        "note": "10",
    },
    # COST OF SALES
    "Opening Inventory": {
        "audited": Decimal("42672377"),
        "type": "COGS",
        "normal": "DEBIT",
        "note": "11",
    },
    "Purchases": {
        "audited": Decimal("944502819"),
        "type": "COGS",
        "normal": "DEBIT",
        "note": "11",
    },
    "Internet Cost of Sales": {
        "audited": Decimal("275961963"),
        "type": "COGS",
        "normal": "DEBIT",
        "note": "12",
    },
    ...
    "Staff Training": {
        "audited": Decimal("6111734"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Subscriptions": {
        "audited": Decimal("7947574"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Medical Expenses": {
        "audited": Decimal("2996059"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Printing & Stationery": {
        "audited": Decimal("6674429"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Rent": {
        "audited": Decimal("5635500"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Utilities": {
        "audited": Decimal("25918146"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Telephone": {
        "audited": Decimal("2110127"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Fuel & Lubricant": {
        "audited": Decimal("14046903"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Pension Expense": {
        "audited": Decimal("4353678"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "ITF & NSITF": {
        "audited": Decimal("802855"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Office Repairs": {
        "audited": Decimal("17832673"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Tools Hire": {
        "audited": Decimal("2682720"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "General Repairs": {
        "audited": Decimal("14674650"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Commission & Fees": {
        "audited": Decimal("1482667"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Insurance": {
        "audited": Decimal("943980"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Contract Tender Fees": {
        "audited": Decimal("1397259"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Base Station Repairs": {
        "audited": Decimal("2009900"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Legal & Professional": {
        "audited": Decimal("2100000"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "NCC Operating Licence": {
        "audited": Decimal("3496454"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Audit Fee": {
        "audited": Decimal("600000"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    "Depreciation": {
        "audited": Decimal("16158678"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "13",
    },
    ...
    "Transport & Travelling": {
        "audited": Decimal("25698354"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "14",
    },
    "Advertising": {
        "audited": Decimal("11725860"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "14",
    },
    "Shipping & Delivery": {
        "audited": Decimal("42157049"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "14",
    },
    ...
    "Salaries & Wages": {
        "audited": Decimal("58344315"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "15",
    },
    "Staff Bonus": {
        "audited": Decimal("6289251"),
        "type": "OPEX",
        "normal": "DEBIT",
        "note": "15",
    },
...
def generate_variance_report(conn):
    ...
    for cat_code, cat_name in categories:
        ...
        print(f"{'─' * 130}")
        print(
            f"{'Account Name':<35} {'Note':>4} {'Audited 2022':>18} {'GL Balance':>18} {'Variance':>18} {'Var %':>8} {'Status':>12}"
        )
        print(f"{'─' * 130}")
        ...
        for acc_name, acc_data in sorted(items.items()):
            ...
            print(
                f"{acc_name:<35} {note:>4} {float(audited_val):>18,.2f} {float(gl_val):>18,.2f} {float(variance):>18,.2f} {var_pct:>7.1f}% {status:>12}"
            )
        ...
        print(
            f"{cat_name + ' TOTAL':<35} {'':>4} {float(cat_audited):>18,.2f} {float(cat_gl):>18,.2f} {float(cat_var):>18,.2f} {cat_var_pct:>7.1f}%"
        )
...
│  ════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════   │""")
    ...
    for acc, data in AUDITED_2022_BALANCES.items():
        if data["type"] == "ASSETS" and data.get("opening", Decimal("0")) != 0:
            ...
            total_debit += amt
            print(
                f"│  {line_num:>3}   {acc:<40} {float(amt):>18,.2f} {float(0):>18,.2f}    Note {data['note']:<5}                          │"
            )
            line_num += 1
    ...
    for acc, data in AUDITED_2022_BALANCES.items():
        if data["type"] == "LIABILITIES" and data.get("opening", Decimal("0")) != 0:
            ...
            total_credit += amt
            print(
                f"│  {line_num:>3}   {acc:<40} {float(0):>18,.2f} {float(amt):>18,.2f}    Note {data['note']:<5}                          │"
            )
            line_num += 1
    ...
    for acc, data in AUDITED_2022_BALANCES.items():
        if data["type"] in ["ASSETS", "LIABILITIES", "EQUITY"]:
            ...
            if movement != 0:
                direction = (
                    "Dr"
                    if (data["normal"] == "DEBIT" and movement > 0)
                    or (data["normal"] == "CREDIT" and movement < 0)
                    else "Cr"
                )
                print(
                    f"│  {acc:<40} {float(opening):>15,.2f} {float(closing):>15,.2f} {float(abs(movement)):>15,.2f} {direction:<5}                 │"
                )
        ...
        for line in opening_lines:
            writer.writerow(
                [
                    "OB-2022-001",
                    "2022-01-01",
                    "Opening balances from audited 2021",
                    line[0],
                    line[1],
                    float(line[2]),
                    float(line[3]),
