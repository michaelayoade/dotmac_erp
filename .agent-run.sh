...
WORKTREE_DIR=/home/dotmac/projects/dotmac_erp/.worktrees/fix-security-c2-3
...
LOG_FILE=/home/dotmac/projects/dotmac_erp/.seabone/logs/fix-security-c2-3.log
TASK_ID=fix-security-c2-3
DESCRIPTION=Security\ fix:\ Restrict\ dynamic\ importlib\ loading\ in\ INTERNAL_SERVICE\ hook\ handler\ to\ prevent\ privilege\ escalation.\ File:\ app/services/hooks/registry.py\,\ around\ line\ 299.\ The\ INTERNAL_SERVICE\ handler\ uses\ importlib.import_module\(\)\ to\ dynamically\ load\ and\ call\ any\ function\ in\ app.services.\*\ with\ arbitrary\ kwargs\ from\ user-supplied\ handler_config\,\ guarded\ only\ by\ a\ startswith\(\'app.services.\'\)\ prefix\ check.\ A\ tenant\ with\ service-hook\ creation\ permission\ can\ invoke\ any\ module-level\ function\ with\ chosen\ arguments.\ Fix:\ Introduce\ an\ explicit\ frozenset\ ALLOWED_INTERNAL_HOOK_TARGETS\ listing\ the\ permitted\ module:callable\ targets\ \(format:\ \'app.module:ClassName.method\'\).\ Reject\ any\ target\ not\ in\ this\ allowlist\ with\ a\ clear\ ValueError\ before\ import.\ Read\ the\ full\ file\ carefully\ first.\ Run\ make\ lint\ \&\&\ pytest\ -x\ --tb=short.\ Commit:\ security:\ restrict\ INTERNAL_SERVICE\ hook\ targets\ to\ explicit\ allowlist
