...
WORKTREE_DIR=/home/dotmac/projects/dotmac_erp/.worktrees/fix-security-c2-2
...
LOG_FILE=/home/dotmac/projects/dotmac_erp/.seabone/logs/fix-security-c2-2.log
TASK_ID=fix-security-c2-2
DESCRIPTION=Security\ fix:\ SSRF\ vulnerability\ in\ service\ hook\ webhook\ handler.\ File:\ app/services/hooks/registry.py\,\ around\ line\ 344.\ The\ WEBHOOK\ handler\ type\ sends\ HTTP\ requests\ to\ any\ URL\ supplied\ in\ handler_config\ without\ URL\ validation\,\ private-IP\ blocking\,\ or\ allowlist\ enforcement.\ The\ automation\ workflow\ already\ has\ proper\ SSRF\ protection\ via\ _validate_webhook_target\(\)\ in\ app/services/finance/automation/workflow.py.\ Fix:\ Import\ and\ call\ _validate_webhook_target\(\)\ before\ dispatching\ the\ httpx\ request\ in\ the\ WEBHOOK\ handler\ block\;\ raise\ ValueError\ \(treated\ as\ execution\ failure\)\ if\ the\ URL\ is\ not\ permitted\;\ ensure\ private\ IPs\ and\ loopback\ are\ always\ blocked\ regardless\ of\ allowlist\ configuration.\ Read\ both\ files\ first\ to\ understand\ the\ patterns.\ Run\ make\ lint\ \&\&\ pytest\ -x\ --tb=short.\ Commit:\ security:\ apply\ SSRF\ protection\ to\ service\ hook\ webhook\ handler
BRANCH=agent/fix-security-c2-2
ENGINE=codex
MODEL=gpt-5.3-codex
