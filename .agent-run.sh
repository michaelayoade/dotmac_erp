...
WORKTREE_DIR=/home/dotmac/projects/dotmac_erp/.worktrees/fix-security-c1-8
...
LOG_FILE=/home/dotmac/projects/dotmac_erp/.seabone/logs/fix-security-c1-8.log
TASK_ID=fix-security-c1-8
DESCRIPTION=Security\ fix:\ Remove\ default\ database\ credentials\ from\ config.py.\ File:\ app/config.py\,\ around\ line\ 13.\ The\ DATABASE_URL\ field\ has\ a\ default\ of\ postgresql+psycopg://postgres:postgres@localhost:5432/dotmac_erp\ which\ would\ be\ used\ in\ production\ if\ the\ env\ var\ is\ missing.\ Fix:\ Remove\ the\ default\ value\ so\ a\ missing\ DATABASE_URL\ raises\ a\ clear\ Pydantic\ validation\ error\ at\ startup.\ Read\ app/config.py\ first\ to\ understand\ the\ Settings\ class\ structure.\ Run\ make\ lint\ \&\&\ pytest\ -x\ --tb=short\ \(note:\ tests\ may\ need\ to\ set\ DATABASE_URL\ explicitly\ if\ they\ relied\ on\ the\ default\).\ Commit:\ security:\ require\ explicit\ DATABASE_URL\ configuration\,\ remove\ default\ credentials
