...
WORKTREE_DIR=/home/dotmac/projects/dotmac_erp/.worktrees/fix-deps-003
...
LOG_FILE=/home/dotmac/projects/dotmac_erp/.seabone/logs/fix-deps-003.log
TASK_ID=fix-deps-003
DESCRIPTION=Migrate\ python-jose\ to\ PyJWT:\ python-jose\ 3.3.0\ has\ CVE-2024-33663\ \(algorithm\ confusion\ attack\,\ ECDSA\ key\ can\ forge\ EdDSA\ tokens\)\ and\ is\ abandoned.\ Migrate\ to\ PyJWT\ 2.x.\ Steps:\ 1\)\ Add\ PyJWT\ to\ pyproject.toml\,\ remove\ python-jose.\ 2\)\ Find\ all\ JWT\ encode/decode\ call\ sites:\ search\ app/\ for\ \'jose\'\,\ \'jwt.encode\'\,\ \'jwt.decode\'\,\ \'JWTError\'\,\ \'ExpiredSignatureError\'.\ 3\)\ PyJWT\ 2.x\ API\ differences:\ jwt.encode\(\)\ returns\ str\ directly\ \(no\ .decode\(\)\ needed\)\,\ jwt.decode\(\)\ takes\ algorithms=\[\]\ list\ not\ algorithm=\ kwarg\,\ exceptions\ are\ jwt.InvalidTokenError\ subclasses.\ 4\)\ Run\ \`poetry\ update\`\,\ then\ \`make\ lint\`\ and\ \`pytest\ -x\ --tb=short\`\ to\ verify.\ The\ project\ uses\ python-jose\ for\ JWT\ auth\ tokens\ in\ app/services/auth/\ and\ app/web/deps.py.
