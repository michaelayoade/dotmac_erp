...
WORKTREE_DIR=/home/dotmac/projects/dotmac_erp/.worktrees/fix-security-c1-10
...
LOG_FILE=/home/dotmac/projects/dotmac_erp/.seabone/logs/fix-security-c1-10.log
TASK_ID=fix-security-c1-10
DESCRIPTION=Security\ fix:\ Narrow\ overly\ broad\ exception\ handling\ in\ secrets.py.\ File:\ app/services/secrets.py\,\ around\ line\ 53.\ A\ bare\ except\ Exception\ swallows\ all\ errors\ when\ reading\ the\ openbao_allow_insecure\ database\ setting.\ Fix:\ 1\)\ Replace\ except\ Exception\ with\ except\ SQLAlchemyError\ \(from\ sqlalchemy.exc\ import\ SQLAlchemyError\).\ 2\)\ Add\ a\ debug-level\ log\ inside\ the\ except\ with\ exc_info=True\ so\ failures\ are\ visible\ in\ diagnostics.\ Read\ the\ file\ first\ to\ understand\ the\ full\ context\ method.\ Run\ make\ lint\ \&\&\ pytest\ -x\ --tb=short.\ Commit:\ fix:\ narrow\ exception\ handling\ in\ secrets.py\ to\ SQLAlchemyError
